    ...
    <>
      <div className='middle-nav-box'>
        <div className='middle-nav-contents'>
          ...
          <div className='menu'>
            <div className='menu-title'>지원 및 서비스</div>
          ...
          <div className='section'>
            <div className='section-title'>제품문의</div>
    ...
    <>
      <div id='RnD-Subnav' className='middle-nav-box'>
        <div className='middle-nav-contents'>
          ...
          <div id='support-sub-nav' className='section'>
            <div onClick={() => props.navigate("/faq")}>FAQ</div>
            <div onClick={() => props.navigate("/qna")}>Q&A</div>
          </div>
        </div>
      </div>
    </>
